...
fh = logging.FileHandler("sans_pv.log")  
...
if __name__ == '__main__':
    sans_pv = read_pv_from_file('sans_pvlist.txt')
    logger.debug('======begin==========')
    sched = TornadoScheduler()
    sched.add_job(job, 'interval', seconds=interval_time, max_instances=6, kwargs={"pvs": sans_pv, "index": 2})
    sched.start()
