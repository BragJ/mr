...
/* Generated from ../O.Common/testwr.dbd */
...
int testwr_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/egcs/zhouke_monitor/monitor_initial_checkout/CheckoutIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"testwr_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    testwr_registerRecordDeviceDriver(*iocshPpdbbase);
}
