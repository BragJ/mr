...
fh = logging.FileHandler("mr_pv.log")  
...
if __name__ == '__main__':
    mr_pv = read_pv_from_file('mr_se_pvlist.txt')
    print(mr_pv)
    logger.debug('======begin==========')
    sched = TornadoScheduler()
    sched.add_job(job, 'interval', seconds=interval_time, max_instances=6, kwargs={"pvs": mr_pv, "index": 2})
    sched.start()
